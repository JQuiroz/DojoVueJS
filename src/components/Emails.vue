<template lang="html">
  <div class="row" style="text-align: left">
    <div class="col-md-4">
      <input type="text" v-model="buscador" align="left" placeholder="Buscar E-mail">
    ...
    <div class="col-md-12">
      <div class="">
        <table class="table table-striped table-bordered ">
          ...
          <tbody>
            <tr class="filaEmail" v-for="email in emailFiltered"  v-bind:class="{seleccionado: email == emailSeleccionado}">
              ...
              <td v-on:click="eliminar(email)" align="center" v-bind:class="{eliminar: email.eliminar}"><i class="fa fa-times"></i></td>
